...
const locations = [
  ...
  ['포식자', 'AD', '수능시험장', '결국사람', '펩시', '유모차레이스', '냉탕에오줌싸서', '스키장상급자코스', '고구려대학교', '수능갤러리', '공사장', '군부대', '훈련소', '롯데마트', '시공의폭풍', '웹툰미리보기사이트', '파인애플피자', '주식', '비트코인', '도박', '토토', '대학원연구실', '온라인클래스', '시대에', 'ISIS', '머리카락못내밀면서', '다이어트하는친구', '지구평면설', '붕어빵에', '자택에서', '교회에서', '절에서', '연애경험이', '친구에어팟', '택시타고', '게임의폭력성을이해하기위해', '배고파서', '배고프면', '벽돌집벽돌', '고깃집공깃밥', '뻐꾸기훔쳐가려고', '최종학력', '고시원냉장고김치통']
]
